#!/usr/bin/env python3
"""Launch the vendor DWA navigation stack through the project's velocity mux."""
...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            GroupAction(
                [
                    # Nav2's controller and recovery servers otherwise publish
                    # directly to the hardware command topic.
