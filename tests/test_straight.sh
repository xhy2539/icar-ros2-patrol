...
sleep 8
echo ">>> goal 车头正前方1米 (x=10.72, y=39.69)"
ros2 topic pub --once /goal_pose geometry_msgs/msg/PoseStamped '{header: {frame_id: map}, pose: {position: {x: 10.72, y: 39.69}, orientation: {x: 0, y: 0, z: 0.7218, w: 0.6921}}}' 2>&1 | head -2
echo ">>> done - 车应该直走"
