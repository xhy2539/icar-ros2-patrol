...
class TrackingStatus {
  final String event; // ready | tracking_started | tracking | no_target | target_lost | tracking_stopped
  final bool enabled;
  ...
  bool get isTracking =>
      event == 'tracking_started' || event == 'tracking';
  bool get isLost => event == 'target_lost' || event == 'no_target';
  bool get isStopped =>
      event == 'tracking_stopped' || event == 'ready';
